...
export default function Banner(): React.JSX.Element {
  const texts = ["Data Scientist", "NLP Engineer", "Data Consultant", "PhD Researcher"];
...
Hello! I am{" "}
              ...
              <Image
                src="/assets/me.png"
                alt="Dzmitry Ashkinadze - Software Engineer and Designer"
                width={300}
                height={300}
...
Hello! I am{" "}
            ...
            <div className="">
              <p className="text-2xl"> Building scalable </p>
        ...
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
            <span>Currently, I&apos;m a Senior Data Science Consultant at</span>
            <span className="flex items-center gap-2">
              <span className="text-purple-400 font-semibold">BASE Life Science,</span>
            </span>
          </p>
          <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
            4+ years of industrial experience building ETL pipelines and scalable AI applications.
            Based in Basel, Switzerland with Swiss Permit C.
          </p>
        </div>
      </div>
    </section>
